...
const HotelInfo = () => {
  ...
  const loadAccessibilityData = async () => {
    ...
    const resp = await fetch(
      "https://a6lnno41t7.execute-api.us-east-1.amazonaws.com/Production/accessibilities"
    );
  ...
  const loadServicesData = async () => {
    // Query the API Gateway
    const resp = await fetch(
      "https://a6lnno41t7.execute-api.us-east-1.amazonaws.com/Production/services"
    );
    let jsonData = await resp.json();
